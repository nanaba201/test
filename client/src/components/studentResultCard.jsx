        ...
        <>
            ...
            <div id="reportCard" style={{
                ...
                <div style={{display: "flex"}}>
                    ...
                    <div>
                        <h2 style={{margin: '5px 0', color: "blue"}}>EDEN INTERNATIONAL SCHOOL</h2>
                        <p style={{margin: '5px 0', fontSize: '14px'}}>
                            (An English Medium Co-Educational Sr. Sec. School (AFFILIATED to C.B.S.E. Delhi)
                        </p>
                        <p style={{margin: '5px 0', fontSize: '14px'}}>
                            SUWANA ROAD, BHILWARA (RAJASTHAN) - 311001
                        </p>
                        <p style={{margin: '5px 0', fontSize: '14px'}}>
                            <span style={{marginRight: "30px"}}>AFFILIATION NO. :- 1730176</span>
                            <span>SCHOOL CODE :- 10525</span>
                        </p>
                ...
                <div style={{
                    ...
                    <h4 style={{margin: 0, textDecoration: 'underline'}}>STUDENT PROFILE</h4>
